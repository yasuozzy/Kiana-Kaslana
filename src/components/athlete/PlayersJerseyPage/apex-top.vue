  ...
  <div class="apex-page">
    ...
    <div class="top-banner">
      ...
      <div class="jersey-section">
        ...
        <div class="jersey-image">
          <img src='../../../assets/logo/plp_banner_1445x800_desktop_home_jersey_2526.jpg' alt="曼城球衣" class="jersey-img" />
        </div>
    ...
    <div class="main-content">
      ...
      <div class="player-info">
        <h1 class="position">{{currentPlayer.position || '前锋' }}</h1> <!-- 球员位置标题 -->
        <h2 class="player-name">{{currentPlayer.name || '埃尔林·哈兰德' }}</h2> <!-- 球员姓名 -->
      </div>
